...
namespace mat
{
	...
	public:
		...
		mat::span span(unsigned, unsigned, unsigned = 3, unsigned = 3);
		...
		friend matrix operator*(const matrix&, const mat::span&);
		friend matrix operator*(const mat::span&, const matrix&);
