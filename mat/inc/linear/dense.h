...
namespace mat
{
	void print(const double*, unsigned, const char* = "", double = 0);
	void print(const double*, unsigned, unsigned, const char* = "", double = 0);

	void print_error(const double*, const double*, unsigned, double, const char* = "");
	void print_error(const double*, const double*, unsigned, unsigned, double, const char* = "");
	...
	double* randu(double*, unsigned, unsigned = 1, double = -1, double = +1, bool = false);
	...
	double* block(double*, const double*, const unsigned*, const unsigned*, unsigned, unsigned, unsigned);
