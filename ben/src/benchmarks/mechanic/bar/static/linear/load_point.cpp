...
//static linear
void tests::bar::static_linear::load_point(void)
{
	//model
	fea::models::Model model("load point", "benchmarks/bar/static/linear");
	...
	//loads
	model.boundary()->add_load_case(1, fea::mesh::nodes::dof::translation_1, 2.4e10);
