...
void tests::bar::dynamic_nonlinear::double_pendulum_2D(void)
{
	...
	model.mesh()->add_element(fea::mesh::elements::type::bar2, {1, 2});

	//initials
	model.boundary()->add_initial(1, fea::mesh::nodes::dof::translation_1, u1, 0);
	model.boundary()->add_initial(1, fea::mesh::nodes::dof::translation_2, v1, 0);
	model.boundary()->add_initial(2, fea::mesh::nodes::dof::translation_1, u2, 0);
	model.boundary()->add_initial(2, fea::mesh::nodes::dof::translation_2, v2, 0);

	//supports
	model.boundary()->add_support(0, fea::mesh::nodes::dof::translation_1);
	model.boundary()->add_support(0, fea::mesh::nodes::dof::translation_2);
	model.boundary()->add_support(1, fea::mesh::nodes::dof::translation_1, 0, 0, m1);
	model.boundary()->add_support(1, fea::mesh::nodes::dof::translation_2, 0, 0, m1);
	model.boundary()->add_support(2, fea::mesh::nodes::dof::translation_1, 0, 0, m2);
	model.boundary()->add_support(2, fea::mesh::nodes::dof::translation_2, 0, 0, m2);

	//loads
	model.boundary()->add_load_case();
	model.boundary()->load_case(0)->add_load_node(1, fea::mesh::nodes::dof::translation_2, -m1 * g);
	model.boundary()->load_case(0)->add_load_node(2, fea::mesh::nodes::dof::translation_2, -m2 * g);
