...
void tests::bar::dynamic_nonlinear::single_pendulum_3D(void)
{
	...
	model.mesh()->add_element(fea::mesh::elements::type::bar3, {0, 1});

	//initials
	model.boundary()->add_initial(1, fea::mesh::nodes::dof::translation_1, ux, vx);
	model.boundary()->add_initial(1, fea::mesh::nodes::dof::translation_2, uy, vy);
	model.boundary()->add_initial(1, fea::mesh::nodes::dof::translation_3, uz, vz);

	//supports
	model.boundary()->add_support(0, fea::mesh::nodes::dof::translation_1);
	model.boundary()->add_support(0, fea::mesh::nodes::dof::translation_2);
	model.boundary()->add_support(0, fea::mesh::nodes::dof::translation_3);
	model.boundary()->add_support(1, fea::mesh::nodes::dof::translation_1, 0, 0, m);
	model.boundary()->add_support(1, fea::mesh::nodes::dof::translation_2, 0, 0, m);
	model.boundary()->add_support(1, fea::mesh::nodes::dof::translation_3, 0, 0, m);

	//loads
	model.boundary()->add_load_case(1, fea::mesh::nodes::dof::translation_3, -m * g);
	...
	dynamic_cast<fea::analysis::solvers::Dynamic_Nonlinear*> (model.analysis()->solver())->watch_dof(1, fea::mesh::nodes::dof::translation_3);
