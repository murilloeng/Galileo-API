...
void tests::bar::dynamic_linear::tent(void)
{
	...
	//initials
	model.boundary()->add_initial(0, fea::mesh::nodes::dof::translation_3, -1.00e-1 * ul, 0);
	...
	//loads
	// model.boundary()->add_load_case(0, fea::mesh::nodes::dof::translation_3, 0, [w](double t) { return 1; });
	...
	dynamic_cast<fea::analysis::solvers::Dynamic_Linear*> (model.analysis()->solver())->watch_dof(0, fea::mesh::nodes::dof::translation_3);
