...
void tests::beam::static_linear::load_shear(void)
{
	//model
	fea::models::Model model("load shear", "benchmarks/beam/static/linear");
	...
	//loads
	// model.boundary()->add_load_case(fea::boundary::loads::type::shear, {}, -1.73e+10);
