...
//	((fea::mesh::sections::RectangleR*) model.mesh()->section(1))->add_bar(12.8e-2, 5.70e-2, 1.78e-2);
	...
	model.mesh()->add_element(fea::mesh::elements::type::beam2C, {0, 1}); //reiforcement: material 2
	model.mesh()->add_element(fea::mesh::elements::type::beam2C, {1, 2}); //reiforcement: material 1
	model.mesh()->add_element(fea::mesh::elements::type::beam2C, {2, 3}); //reiforcement: material 2
	model.mesh()->add_element(fea::mesh::elements::type::beam2C, {3, 0}); //reiforcement: material 1
	...
	model.boundary()->load_case(0)->add_load_node(2, fea::mesh::nodes::dof::translation_1, -2e1);
	model.boundary()->load_case(0)->add_load_node(2, fea::mesh::nodes::dof::translation_2, -1e3 + 1e1);
	model.boundary()->load_case(0)->add_load_node(3, fea::mesh::nodes::dof::translation_2, -1e3 - 1e1);
