...
void tests::beam::static_nonlinear::inelastic::steel::cantilever_axial(void)
{
	/*
	Steel cantilever beam subjected to an axial force
		Exact solution:
		P = sy w h
	*/
	...
	//model
	fea::models::Model model("cantilever axial", "benchmarks/beam/static/nonlinear/inelastic/steel");
	...
	model.boundary()->add_load_case(1, fea::mesh::nodes::dof::translation_1, sy * w * h);
