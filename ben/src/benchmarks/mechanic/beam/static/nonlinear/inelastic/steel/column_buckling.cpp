...
void tests::beam::static_nonlinear::inelastic::steel::column_buckling(void)
{
	...
	//loads
	model.boundary()->add_load_case(1, fea::mesh::nodes::dof::translation_2, -1.5545e1);
	...
	dynamic_cast<fea::analysis::solvers::Static_Nonlinear*>(model.analysis()->solver())->watch_dof(6, fea::mesh::nodes::dof::translation_1);
