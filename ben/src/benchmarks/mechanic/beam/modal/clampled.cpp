...
//state
void tests::beam::modal::clamped(void)
{

	//Modal analysis of a clamped beam
	//Exact solution: wn = (an / L)**2 * sqrt(E * I / r / A)

	//data
	const unsigned n = 50;
	const double L = 3.00e+00;
	const double bl[] = {4.7300e+00, 7.8532e+00, 1.0996e+01, 1.4137e+01, 1.7279e+01};

	//model
	fea::models::Model model("clamped beam", "benchmarks/beam/modal");
