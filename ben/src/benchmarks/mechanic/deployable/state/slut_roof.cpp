...
void tests::deployable::state::slut_roof(void)
{
	...
	for(unsigned i = 0; i < n; i++)
	{
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 0, 6 * i + 1});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 4, 6 * i + 1});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 4, 6 * i + 2});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 5, 6 * i + 2});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 5, 6 * i + 3});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 0, i + 1 != n ? 6 * (i + 1) + 1 : 1});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 4, i + 1 != n ? 6 * (i + 1) + 1 : 1});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 4, i + 1 != n ? 6 * (i + 1) + 2 : 2});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 5, i + 1 != n ? 6 * (i + 1) + 2 : 2});
		model.mesh()->add_element(fea::mesh::elements::type::bar3, {6 * i + 5, i + 1 != n ? 6 * (i + 1) + 3 : 3});
	}
	...
	for(unsigned i = 0; i < n; i++)
	{
		...
		{
			model.boundary()->add_support(6 * i + j, fea::mesh::nodes::dof::translation_1);
			model.boundary()->add_support(6 * i + j, fea::mesh::nodes::dof::translation_2);
		}
	...
	dynamic_cast<fea::analysis::solvers::State*> (model.analysis()->solver())->watch_dof(0, fea::mesh::nodes::dof::translation_1);
