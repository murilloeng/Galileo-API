...
void tests::deployable::state::arch_polar(void)
{
	...
	for(unsigned i = 0; i < n; i++)
	{
		...
		model.mesh()->add_element(fea::mesh::elements::type::beam2C, {6 * i + 2, 6 * i + 4});
		model.mesh()->add_element(fea::mesh::elements::type::beam2C, {6 * i + 1, 6 * i + 3});
		model.mesh()->add_element(fea::mesh::elements::type::beam2C, {6 * i + 3, 6 * i + 5});
	}
	...
	for(unsigned i = 0; i < n; i++)
	{
		...
		//supports
		// model.boundary()->add_support(6 * i + 0, fea::mesh::nodes::dof::rotation_3, t1);
		// model.boundary()->add_support(6 * i + 2, fea::mesh::nodes::dof::rotation_3, t1);
		// model.boundary()->add_support(6 * i + 4, fea::mesh::nodes::dof::rotation_3, t1);
		// model.boundary()->add_support(6 * i + 1, fea::mesh::nodes::dof::rotation_3, t2);
		// model.boundary()->add_support(6 * i + 3, fea::mesh::nodes::dof::rotation_3, t2);
		// model.boundary()->add_support(6 * i + 5, fea::mesh::nodes::dof::rotation_3, t2);
		// model.boundary()->add_support(6 * i + 0, fea::mesh::nodes::dof::translation_1, u0);
		// model.boundary()->add_support(6 * i + 0, fea::mesh::nodes::dof::translation_2, v0);
		// model.boundary()->add_support(6 * i + 1, fea::mesh::nodes::dof::translation_1, u1);
		// model.boundary()->add_support(6 * i + 1, fea::mesh::nodes::dof::translation_2, v1);
		// model.boundary()->add_support(6 * i + 2, fea::mesh::nodes::dof::translation_1, u2);
		// model.boundary()->add_support(6 * i + 2, fea::mesh::nodes::dof::translation_2, v2);
		// model.boundary()->add_support(6 * i + 3, fea::mesh::nodes::dof::translation_1, u2);
		// model.boundary()->add_support(6 * i + 3, fea::mesh::nodes::dof::translation_2, v2);
		// model.boundary()->add_support(6 * i + 4, fea::mesh::nodes::dof::translation_1, u3);
		// model.boundary()->add_support(6 * i + 4, fea::mesh::nodes::dof::translation_2, v3);
		// model.boundary()->add_support(6 * i + 5, fea::mesh::nodes::dof::translation_1, u4);
		// model.boundary()->add_support(6 * i + 5, fea::mesh::nodes::dof::translation_2, v4);
	}
