...
const static unsigned ni = 4;
const static unsigned nm = 10;
const static unsigned ns = 900;
...
static void create_elements(fea::models::Model* model)
{
	for(unsigned i = 0; i < nd; i++)
	{
		...
		const unsigned j = i + 1 != nd ? i + 1 : 0;
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {14 * i +  4, 14 * i +  2});
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {14 * i +  4, 14 * i +  7});
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {14 * i +  5, 14 * i +  3});
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {14 * i +  5, 14 * i + 11});
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {14 * i + 14, 14 * i +  8});
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {14 * i + 15, 14 * i + 12});
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {14 * i + 14, 14 * j + 13});
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {14 * i + 15, 14 * j +  9});
		((fea::mesh::elements::Beam*) model->mesh()->element(8 * i + 0))->orientation(-sin(t), cos(t), 0);
		((fea::mesh::elements::Beam*) model->mesh()->element(8 * i + 1))->orientation(-sin(t), cos(t), 0);
		((fea::mesh::elements::Beam*) model->mesh()->element(8 * i + 2))->orientation(-sin(t), cos(t), 0);
		((fea::mesh::elements::Beam*) model->mesh()->element(8 * i + 3))->orientation(-sin(t), cos(t), 0);
		((fea::mesh::elements::Beam*) model->mesh()->element(8 * i + 4))->orientation(cos(t + M_PI / nd), sin(t + M_PI / nd), 0);
		((fea::mesh::elements::Beam*) model->mesh()->element(8 * i + 5))->orientation(cos(t + M_PI / nd), sin(t + M_PI / nd), 0);
		((fea::mesh::elements::Beam*) model->mesh()->element(8 * i + 6))->orientation(cos(t + M_PI / nd), sin(t + M_PI / nd), 0);
		((fea::mesh::elements::Beam*) model->mesh()->element(8 * i + 7))->orientation(cos(t + M_PI / nd), sin(t + M_PI / nd), 0);
	}
}
...
static void create_loads(fea::models::Model* model)
{
	...
	{
		const double t = (2 * i + 1) * M_PI / nd;
		model->boundary()->load_case(0)->add_load_node(14 * i +  6, fea::mesh::nodes::dof::translation_1, -mat::sign(open) * Pr * cos(t));
		model->boundary()->load_case(0)->add_load_node(14 * i +  6, fea::mesh::nodes::dof::translation_2, -mat::sign(open) * Pr * sin(t));
		model->boundary()->load_case(0)->add_load_node(14 * i + 10, fea::mesh::nodes::dof::translation_1, -mat::sign(open) * Pr * cos(t));
		model->boundary()->load_case(0)->add_load_node(14 * i + 10, fea::mesh::nodes::dof::translation_2, -mat::sign(open) * Pr * sin(t));
	}
}
static void create_initial(fea::models::Model* model)
{
	if(!open)
	{
		...
		{
			const double t = (2 * i + 1) * M_PI / nd;
			model->boundary()->add_initial(14 * i + 4, fea::mesh::nodes::dof::translation_1, 2e-3 * L * cos(t), 0);
			model->boundary()->add_initial(14 * i + 5, fea::mesh::nodes::dof::translation_2, 2e-3 * L * sin(t), 0);
		}
	}
}
static void create_supports(fea::models::Model* model)
{
	...
	for(unsigned i = 0; i < nd; i++)
	{
		model->boundary()->add_support(14 * i +  6, fea::mesh::nodes::dof::rotation_3);
		model->boundary()->add_support(14 * i + 10, fea::mesh::nodes::dof::rotation_3);
	}
}
...
static void create_solver(fea::models::Model* model)
{
	...
	const double ug = model->mesh()->node(1)->state(fea::mesh::nodes::dof::translation_3);
