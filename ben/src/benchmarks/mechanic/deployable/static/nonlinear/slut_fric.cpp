...
void tests::deployable::static_nonlinear::slut_fric(void)
{
	...
	model.mesh()->add_element(fea::mesh::elements::type::beam3C, {3, 4});
	model.mesh()->add_element(fea::mesh::elements::type::beam3C, {4, 5});
	...
	//loads
	model.boundary()->add_load_case(3, fea::mesh::nodes::dof::translation_1, my / l);
	...
	dynamic_cast<fea::analysis::solvers::Static_Nonlinear*>(model.analysis()->solver())->load_guess(1e+1);
