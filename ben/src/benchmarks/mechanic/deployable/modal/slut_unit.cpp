...
static void create_elements(fea::models::Model* model)
{
	...
	for(unsigned i = 0; i < nd; i++)
	{
		...
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  2, 0}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  4, 1}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  3, 22 * i +  6}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  5, 22 * i +  7}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  6, 22 * i + 14}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  7, 22 * i + 21}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  8, 22 * i + 16}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  9, 22 * i + 23}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i + 10, 22 * i + 11}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i + 10, 22 * i + 12}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i + 10, 22 * i + 13}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i + 17, 22 * i + 18}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i + 17, 22 * i + 19}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i + 17, 22 * i + 20}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  8, 22 * (i + 1 != nd ? i + 1 : 0) + 22}, 0);
		model->mesh()->add_element(fea::mesh::elements::type::beam3C, {22 * i +  9, 22 * (i + 1 != nd ? i + 1 : 0) + 15}, 0);
...
static void create_solver(fea::models::Model* model)
{
	...
	dynamic_cast<fea::analysis::solvers::Modal*>(model->analysis()->solver())->spectre_max(4);
