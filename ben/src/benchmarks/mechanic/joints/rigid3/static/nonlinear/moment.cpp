...
void tests::joint::rigid3::static_nonlinear::moment(void)
{
	/*
	Rigid link with moment
	 */
	...
	//model
	fea::models::Model model("moment", "benchmarks/joints/rigid3/static/nonlinear");
	...
	dynamic_cast<fea::analysis::solvers::Static_Nonlinear*>(model.analysis()->solver())->load_max(1e+1);
	dynamic_cast<fea::analysis::solvers::Static_Nonlinear*>(model.analysis()->solver())->step_max(1e+3);
