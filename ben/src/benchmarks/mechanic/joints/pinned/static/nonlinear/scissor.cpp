...
void tests::joint::pinned::static_nonlinear::scissor(void)
{
	//model
	fea::models::Model model("scissor", "benchmarks/joints/pinned/static nonlinear");
	...
	((fea::mesh::joints::Pinned*) model.mesh()->joint(0))->stiffness(0, k);
	...
	//loads
	model.boundary()->add_load_case(3, fea::mesh::nodes::dof::translation_1, k / l);
