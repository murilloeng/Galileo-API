...
void tests::joint::pinned::static_linear::frame(void)
{
	/*
	portal frame
	...
	//model
	fea::models::Model model("frame", "benchmarks/joints/pinned/static linear");
...
//	((fea::mesh::sections::Generic*) model.mesh()->section(1))->inertia_z(Ib);
	...
	//elements
	model.mesh()->add_element(fea::mesh::elements::type::beam2C, {1, 2}, { 0 }, 0);
	model.mesh()->add_element(fea::mesh::elements::type::beam2C, {3, 4}, { 0 }, 1);
	model.mesh()->add_element(fea::mesh::elements::type::beam2C, {4, 5}, { 0 }, 1);
	model.mesh()->add_element(fea::mesh::elements::type::beam2C, {6, 7}, { 0 }, 0);
	...
	((fea::mesh::joints::Pinned*) model.mesh()->joint(0))->stiffness(0, kc);
	((fea::mesh::joints::Pinned*) model.mesh()->joint(1))->stiffness(0, kb);
	((fea::mesh::joints::Pinned*) model.mesh()->joint(2))->stiffness(0, kb);
	((fea::mesh::joints::Pinned*) model.mesh()->joint(3))->stiffness(0, kc);

	//supports
	model.boundary()->add_support(0, fea::mesh::nodes::dof::rotation_3);
	model.boundary()->add_support(8, fea::mesh::nodes::dof::rotation_3);
	model.boundary()->add_support(0, fea::mesh::nodes::dof::translation_1);
	model.boundary()->add_support(0, fea::mesh::nodes::dof::translation_2);
	model.boundary()->add_support(8, fea::mesh::nodes::dof::translation_1);
	model.boundary()->add_support(8, fea::mesh::nodes::dof::translation_2);

	//loads
	model.boundary()->add_load_case();
	model.boundary()->load_case(0)->add_load_node(2, fea::mesh::nodes::dof::translation_1, +1.0e4);
	model.boundary()->load_case(0)->add_load_node(4, fea::mesh::nodes::dof::translation_2, -1.0e5);

	//solver
	model.analysis()->solver(fea::analysis::solvers::type::static_linear);
	model.analysis()->solver()->watch_dof(4, fea::mesh::nodes::dof::translation_2);
