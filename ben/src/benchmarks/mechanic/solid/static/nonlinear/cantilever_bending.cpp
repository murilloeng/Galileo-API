...
void tests::solid::static_nonlinear::cantilever_bending(void)
{
	//model
	fea::models::Model model("cantilever bending", "benchmarks/solid/static/nonlinear");
	...
	dynamic_cast<fea::analysis::solvers::Static_Nonlinear*>(model.analysis()->solver())->watch_dof(index_node(nz, 0, 0), fea::mesh::nodes::dof::translation_3);
