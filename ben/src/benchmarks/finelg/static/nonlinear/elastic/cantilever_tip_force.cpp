...
void tests::finelg::static_nonlinear::elastic::cantilever_tip_force(void)
{
	//data
	...
	//model
	fea::models::Model model("cantilever tip force", "benchmarks/finelg/static/nonlinear/elastic");
	...
	dynamic_cast<fea::analysis::solvers::Static_Nonlinear*>(model.analysis()->solver())->load_guess(1e0);
